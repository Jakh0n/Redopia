...
"[project]/http/axios.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
const SERVER_URL = ("TURBOPACK compile-time value", "http://localhost:8080");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$http$2f$axios$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/http/axios.ts [app-route] (ecmascript)");
...
const authOptions = {
    providers: [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$providers$2f$credentials$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
            ...
            async authorize (credentials) {
                const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$http$2f$axios$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["axiosClient"].get(`/api/user/profile/${credentials?.userId}`);
    ...
    callbacks: {
        async session ({ session }) {
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$http$2f$axios$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["axiosClient"].get(`/api/user/profile/${session.user?.name}`);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$options$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/lib/auth-options.ts [app-route] (ecmascript)");
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__c3205e._.js.map